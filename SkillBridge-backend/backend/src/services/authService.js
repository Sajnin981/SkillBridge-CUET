 ...
 *
 * Students and companies must be approved by an admin before they can log in.
 * Admins are always allowed (they are manually seeded).
 */
const loginWithRole = async (email, password, role) => {
  ...
  // Approval gate for students and companies (admins are always allowed).
